...
public class DoorRotationLiteEditor : Editor
{
    ...
    SerializedProperty doorScaleProp, pivotPositionProp, hingePositionProp, visualizeHingeProp, hingeColorProp, closeTime;
    SerializedProperty initialAngleProp, rotationAngleProp, rotationSideProp, speedProp, timesMoveableProp;
    SerializedProperty openSoundProp, closeSoundProp;
    ...
    public void OnEnable()
    {
        ...
        closeTime = serializedObject.FindProperty("closeTime");
    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (ToolBarIndex)
        {
            ...
            case 0:
                ...
                EditorGUILayout.PropertyField(closeTime, new GUIContent("Auto Close Time"));
            ...
            case 2:
                EditorGUILayout.Space();
                EditorGUILayout.LabelField("<b>Sound Settings</b>", style);
                EditorGUILayout.PropertyField(openSoundProp, new GUIContent("Opening sound", "Opening sound of the door/window."));
                EditorGUILayout.PropertyField(closeSoundProp, new GUIContent("Closing sound", "Closing sound of the door/window."));
